package com.example.wkiandroid.repositories

import com.example.wkiandroid.models.WikiPage
import com.example.wkiandroid.models.WikiThumbnail
...
class FavoritesRepository (val databaseHelper : ArticleDatabaseOpenHelper) {
    ...
    fun isArticleFavorite(pageId: Int) : Boolean {
        ...
        return pages.any { page -> page.pageid == pageId}
    }

    fun getAllFavorites() : ArrayList<WikiPage> {
        var pages : ArrayList<WikiPage> = ArrayList<WikiPage>()
